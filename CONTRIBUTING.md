...
- **Fork the repo**
- **Clone the repo** and set it up (check out the [manual installation](https://github.com/parthshah04/nodejs-expressjs-backend-boilerplate#manual-installation) section in README.md)
